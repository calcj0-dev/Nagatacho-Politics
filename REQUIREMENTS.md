...
| 緊急記者会見 | 自分の支持率+3% |
| スキャンダルリーク | 相手の支持率-3% |
| 政治献金パーティー | 政治資金+4億円を即時獲得 |
| 街頭演説 | 支持率+2%。場にカードが2枚以上なら代わりに+5% |
| 国会質問 | 相手の場からランダムに1枚選び、次の相手のターンで能力使用不可にする |
| 政策発表 | 自分の支持率+4%。ただし相手の支持率も+1% |
| 内閣改造 | 自分の場の政治家カード1枚を捨て札にし、手札から別の政治家カードを場に出す（手札に政治家カードがない場合は使用不可。「1ターンに場に出せるのは1枚」の制限外） |
| 党首討論 | 自分の支持率が相手より低い場合+7%、そうでなければ+2%（判定は内部処理、結果は「上がった」のみ表示） |
| 地方遊説 | 自分の支持率+3% |
| 献金スキャンダル | 相手の政治資金-3億(0未満にはならない) |
| 政策転換 | 相手の支持率-2%、自分の支持率+2% |
| マスコミ対策 | 次の相手のターンで受ける支持率減少を無効化 |
| 派閥抗争 | 相手の場の政治家カードからランダムに1枚選び、相手の手札に戻す（相手の場にカードがない場合は空振り） |
| 緊急世論調査 | 即座に両者の支持率を確認できる |
