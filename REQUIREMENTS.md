...
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 一口でおにぎり | 自分の支持率-5%。おにぎりの産地が注目され、地方団体からの献金で政治資金+7億円を即時獲得 | 0億 |
| 能力2 | ゲル顔で威嚇 | 独特の表情で相手を威圧。相手の支持率-8%、さらに相手の次ターンの能力コスト+1億 | 4億 |

**S・タカイチ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 早苗ネーム連呼 | 自分の名前を連呼して存在感アピール。支持率+8%、政治資金-2億 | 2億 |
| 能力2 | 靖国参拝決行 | 支持率+12%、ただし次のターン相手の攻撃効果が1.5倍になる | 5億 |

**S・コイズミ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | セクシー発言 | 「気候変動はセクシーに」などの迷言で物議。ランダムで支持率+15%か-10% | 1億 |
| 能力2 | レジ袋有料化 | 環境アピールだが不評。相手の支持率-5%、自分も-3%だが政治資金+6億 | 2億 |

**T・コウノ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | Twitterブロック祭り | 批判者を片っ端からブロック。相手の次の攻撃を無効化するが、自分の支持率-3% | 2億 |
| 能力2 | ハンコ廃止！ | デジタル化推進で支持率+9%、次のターンの資金収入+3億 | 4億 |

**Y・スガ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | ガースーです | 独特の自己紹介で親しみアピール。支持率+8%、さらに場にカードが1枚以下なら追加+4% | 3億 |
...
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 文春砲サバイバル | 不倫疑惑報道を乗り越える。自分の支持率-8%だが、政治資金+10億獲得＆次の2ターン相手の攻撃無効 | 0億 |
| 能力2 | 手取りを増やす！ | 国民の手取りアップを訴求。支持率+10%、政治資金+5億 | 4億 |

**Y・モリ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 若手のフットワーク | 身軽に動いて支持獲得。支持率+9%、次のターンの能力コストが全て-1億 | 3億 |
| 能力2 | 次世代の星 | 若手ならではのフレッシュさ。支持率+7%、さらに場のカードが2枚以下なら追加+5% | 3億 |

**K・シンバ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 静岡茶で一服 | お茶を飲んで一息。政治資金+8億、次のターンの防御効果+50% | 2億 |
| 能力2 | 国対の調整力 | 水面下の調整で場を整える。自分の場の全カードの次ターンコスト-2億、支持率+6% | 4億 |

**K・オオツカ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 日銀理論で論破 | 経済理論で相手を圧倒。相手の支持率-8%、自分の政治資金+7億 | 5億 |
| 能力2 | 金融緩和論 | 難しい経済政策を語る。支持率+8%、政治資金+4億、ただしランダムで-3%の可能性も | 3億 |

**T・イトウ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 元アナの美声 | 元アナウンサーの滑舌と声で訴求力UP。支持率+10%、次のターンも+4%の追加効果 | 4億 |
...
| 街頭演説の神対応 | 厳しいヤジをユーモアで返し、聴衆を味方につける。| 支持率+4%。場にカードが2枚以上なら+8% |
| ドリル破壊 | 物理的に証拠を消し去る強硬手段。| 次の支持率が下がるイベントを一度だけスキップするが、政治資金-5億円。 |
| 政党内改革 | 旧弊を打破する「トカゲの尻尾切り」か「刷新」か。 | 自分の場の政治家カード1枚を捨て札にし、手札から別の政治家カードを場に出す（手札に政治家カードがない場合は使用不可。「1ターンに場に出せるのは1枚」の制限外） |
| 党首討論 | 2分割画面で映し出される、言葉の真剣勝負。 | 自分の支持率が相手より低い場合+10%、そうでなければ+4% |
| 雪国の雪かき | 歩道の雪を路上に撒き散らす「雪かき」が炎上。 | 相手の支持率-5% |
| このハゲェー！！ | 秘書への苛烈な暴言録音がSNSで大拡散。 | 相手の支持率-5%。相手の場に女性政治家がいればイメージダウンで更に相手の支持率-7%。 |
...
| 議員会館不倫 | スキャンダルで相手にダメージ。 | 相手の支持率-8%、ただし自分も巻き添えで-3% |
