...
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 一口でおにぎり | 自分の支持率-3%。おにぎりの産地が注目され、地方団体からの献金で政治資金+5億円を即時獲得 | 0億 |
| 能力2 | ゲル顔で威嚇 | 独特の表情で相手を威圧。相手の支持率-5%、さらに相手の次ターンの能力コスト+1億 | 3億 |

**S・タカイチ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 早苗ネーム連呼 | 自分の名前を連呼して存在感アピール。支持率+6%、政治資金-2億 | 2億 |
| 能力2 | 靖国参拝決行 | 支持率+8%、ただし次のターン相手の攻撃効果が1.5倍になる | 4億 |

**S・コイズミ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | セクシー発言 | 「気候変動はセクシーに」などの迷言で物議。ランダムで支持率+12%か-8% | 1億 |
| 能力2 | レジ袋有料化 | 環境アピールだが不評。相手の支持率-3%、自分も-2%だが政治資金+5億 | 2億 |

**T・コウノ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | Twitterブロック祭り | 批判者を片っ端からブロック。相手の次の攻撃を無効化するが、自分の支持率-2% | 2億 |
| 能力2 | ハンコ廃止！ | デジタル化推進で支持率+6%、次のターンの資金収入+2億 | 3億 |

**Y・スガ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | ガースーです | 独特の自己紹介で親しみアピール。支持率+5%、さらに場にカードが1枚以下なら追加+3% | 3億 |
| 能力2 | パンケーキ会食 | メディアと懐柔策。相手の次の攻撃-3%、政治資金+3億 | 2億 |
...
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 文春砲サバイバル | 不倫疑惑報道を乗り越える。自分の支持率-6%だが、政治資金+8億獲得＆次の2ターン相手の攻撃無効 | 0億 |
| 能力2 | 手取りを増やす！ | 国民の手取りアップを訴求。支持率+7%、政治資金+4億 | 3億 |

**Y・モリ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 若手のフットワーク | 身軽に動いて支持獲得。支持率+6%、次のターンの能力コストが全て-1億 | 3億 |
| 能力2 | 次世代の星 | 若手ならではのフレッシュさ。支持率+5%、さらに場のカードが2枚以下なら追加+4% | 3億 |

**K・シンバ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 静岡茶で一服 | お茶を飲んで一息。政治資金+6億、次のターンの防御効果+50% | 2億 |
| 能力2 | 国対の調整力 | 水面下の調整で場を整える。自分の場の全カードの次ターンコスト-1億、支持率+4% | 4億 |

**K・オオツカ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 日銀理論で論破 | 経済理論で相手を圧倒。相手の支持率-5%、自分の政治資金+6億 | 4億 |
| 能力2 | 金融緩和論 | 難しい経済政策を語る。支持率+5%、政治資金+3億、ただしランダムで-2%の可能性も | 3億 |

**T・イトウ**
| 能力 | 名称 | 効果 | コスト |
|------|------|------|--------|
| 能力1 | 元アナの美声 | 元アナウンサーの滑舌と声で訴求力UP。支持率+7%、次のターンも+3%の追加効果 | 3億 |
| 能力2 | ママ目線の追及 | 子育て世代の代弁で共感を得る。支持率+6%、相手の支持率-2% | 4億 |
...
| カード名 | 説明 | 効果 |
|----------|----------------|------|
| トランプ関税 | 外圧による経済パニック。  | 両プレイヤーの政治資金が20%没収される。 |
| 記憶にございません | 国会答弁の定番。 | 相手からの支持率低下を一度だけ無効化できるが、効果発動後の自分のターンにドローができない。 |
| 政治献金パーティー | 豪華ホテルの「勉強会」で資金集め。 | 政治資金+5億円を即時獲得 |
| 街頭演説の神対応 | 厳しいヤジをユーモアで返し、聴衆を味方につける。| 支持率+2%。場にカードが2枚以上なら+5% |
| ドリル破壊 | 物理的に証拠を消し去る強硬手段。| 次の支持率が下がるイベントを一度だけスキップするが、政治資金-3億円。 |
| 政党内改革 | 旧弊を打破する「トカゲの尻尾切り」か「刷新」か。 | 自分の場の政治家カード1枚を捨て札にし、手札から別の政治家カードを場に出す（手札に政治家カードがない場合は使用不可。「1ターンに場に出せるのは1枚」の制限外） |
| 党首討論 | 2分割画面で映し出される、言葉の真剣勝負。 | 自分の支持率が相手より低い場合+7%、そうでなければ+2% |
| 雪国の雪かき | 歩道の雪を路上に撒き散らす「雪かき」が炎上。 | 相手の支持率-3% |
| このハゲェー！！ | 秘書への苛烈な暴言録音がSNSで大拡散。 | 相手の支持率-3%。相手の場に女性政治家がいればイメージダウンで更に相手の支持率-5%。 |
| 寝てない自慢 | 災害の緊急対応で「「不眠不休」をアピールし、同情と期待を買う。 | 自分の支持率+2% |
| マスコミ対策 | 記者クラブとの会食や巧妙な情報操作。 | 次の相手のターンで受ける支持率減少を無効化 |
| 応援演説 | 「党の顔」がマイクを握り、党勢を拡大。 | 自分の山札の中から政治家カードをランダムで手札に加える。山札に政治家カードが無い場合は効果なし |
| 緊急世論調査 | リアルタイムの支持率を分析し、戦術を修正する。 | 即座に自分の政党の支持率を確認できる |
